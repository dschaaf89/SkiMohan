...
export const TypesForm: React.FC<TypeFormProps> = ({
  initialData
}) => {
  ...
  const onSubmit = async (data: TypeFormValues) => {
    try {
      setLoading(true);
      if (initialData) {
        await axios.patch(`/api/${params.seasonId}/types/${params.typeId}`, data);
      } else {
        await axios.post(`/api/${params.seasonId}/types`, data);
      }
      router.refresh();
      router.push(`/${params.seasonId}/types`);
  ...
  const onDelete = async () => {
    try {
      setLoading(true);
      await axios.delete(`/api/${params.seasonId}/types/${params.typesId}`);
      router.refresh();
      router.push(`/${params.seasonId}/types`);
